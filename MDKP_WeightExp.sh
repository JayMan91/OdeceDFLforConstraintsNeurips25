...
for s in 11 12 13 14 15; do
    ...
    for alpha in 0.8 0.7 0.6 0.5 0.4 0.3 0.2; do
        python3 KnapsackWeightExp.py --noise_width 0.25 --deg 6 --num_items 50 --seed $s --model_name odece --ial_reduction mean --wol_type nil --infeasibility_aversion_coeff $alpha --fix_alpha --max_epochs 20 --lr 0.05
    done
