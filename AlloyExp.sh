...
for s in 11 12 13 14 15; do
    ...
    for alpha in 0.8 0.7 0.6 0.5 0.4 0.3 0.2; do
    	python3 AlloyExp.py --penaltyTerm 0.5 --seed $s --model_name odece --ial_reduction mean --wol_type nil --infeasibility_aversion_coeff $alpha --fix_alpha --max_epochs 20 --lr 0.001
    done
    python3 AlloyExp.py --penaltyTerm 0.5 --seed $s --model_name TwoStageIntOpt --thr 0.1 --damping 0.01 --lr 0.05 --max_epochs 20
done